...
errorCodeLeft, leftMotor = vrep.simxGetObjectHandle(clientId, "leftMotor", vrep.simx_opmode_oneshot_wait)
errorCodeRight, rightMotor = vrep.simxGetObjectHandle(clientId, "rightMotor", vrep.simx_opmode_oneshot_wait)
